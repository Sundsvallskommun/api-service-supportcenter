...
public class CreateAssetRequest {
	...
	@Schema(examples = "x_dell", description = "Manufacturer", requiredMode = NOT_REQUIRED)
	private String manufacturer;

	@Schema(examples = "Latitude 9000", description = "Model name", requiredMode = REQUIRED)
	@NotBlank(message = "must be provided")
	private String modelName;

	@Schema(examples = "Latitude 9000", description = "Description of asset", requiredMode = NOT_REQUIRED)
	private String modelDescription;

	@Schema(examples = "CD23456", description = "Serial number", requiredMode = REQUIRED)
	@NotBlank(message = "must be provided")
	private String serialNumber;

	@Schema(examples = "00:00:0a:bb:28:fc", description = "MAC address for the unit", requiredMode = NOT_REQUIRED)
	@ValidMacAddress
	private String macAddress;

	@Schema(examples = "2022-01-01", description = "Warranty end date", requiredMode = NOT_REQUIRED)
	private LocalDate warrantyEndDate;

	@Schema(examples = "0", description = "Supplier status", requiredMode = NOT_REQUIRED)
	private String supplierStatus;

	@Schema(examples = "0", description = "Hardware status", requiredMode = NOT_REQUIRED)
	private String hardwareStatus;

	@Schema(examples = "2022-01-01", description = "Delivery date", requiredMode = NOT_REQUIRED)
	private LocalDate deliveryDate;

	@Schema(examples = "2281", description = "Municipality id", hidden = true, requiredMode = NOT_REQUIRED)
