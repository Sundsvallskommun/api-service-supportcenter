...
public class SysManSundsvallConfiguration {

	public static final String CLIENT_ID = "sysman-sundsvall";
	...
	Client okHttpClient(final SysManProperties sysManProperties, final Truststore truststore) {
		return SysManFeignFactory.okHttpClient(sysManProperties.sundsvall(), truststore);
	}
